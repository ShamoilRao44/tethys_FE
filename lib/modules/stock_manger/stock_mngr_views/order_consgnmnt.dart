                          ...
                          return Padding(
                            ...
                            child: GestureDetector(
                              ...
                              child: AnimatedContainer(
                                ...
                                padding: EdgeInsets.all(14.0),
                                decoration: BoxDecoration(
                                  color: c.isExpandedForConsignments[index] ? AppColors.lightBlue : AppColors.lightBlue,
                                  borderRadius: BorderRadius.circular(10.0),
                                ),
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    AppText(
                                                      text: 'Invoice No.: ${c.consignmentsList[index].invoice ?? ''}',
                                                      color: AppColors.txtColor,
                                                      size: MediaQuery.of(context).size.width > 400 ? 14 : 14.h,
                                                      fontFamily: AppFonts.interRegular,
                                                      fontWeight: FontWeight.w400,
                                                    ...
                                                    SizedBox(width: 24),
                                                    AppText(
                                                      text: 'Total Amount: ${c.consignmentsList[index].invValue ?? ''}',
                                                      color: AppColors.txtColor,
                                                      size: MediaQuery.of(context).size.width > 400 ? 14 : 14.h,
                                                      fontFamily: AppFonts.interRegular,
                                                      fontWeight: FontWeight.w400,
